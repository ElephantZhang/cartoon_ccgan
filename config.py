...
# TRAIN_CARTOON_DIR = "/mnt/data/ZhangYushan/face_cartoon/pa_face"
TRAIN_PHOTO_DIR = os.path.join(TRAIN_DIR, "photo")
# TRAIN_PHOTO_DIR = "/mnt/data/ZhangYushan/face_photo"
...
LAMBDA_STRUCTURE = 1500 #(author's code used 200)
